		...
		methods: {
			...
			getUpdateInfo() {
				const url = process.env.NODE_ENV === 'development' ?
					'https://dev.doscs.com/demo/chengya/dosapp/download/cysh.apk' : 'https://cy.doscs.com/dosapp/download/cysh.apk'
				// 这里的返回的数据跟后台约定
				let data = [{
					os: 'android',
					version: this.config.versionApp, //最新版本
					note: '',
					download_url: url,
				}, {
					os: 'ios',
...
<style lang="scss" scoped>
	...
	.update-wrap {
		...
		.updata-bg-img {
			...
			width: 580rpx;
			height: 440rpx;
			background: url(../../static/image/update-img.png) no-repeat;
