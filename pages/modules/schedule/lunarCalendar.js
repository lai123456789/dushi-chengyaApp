...
let now, GY, GM, GD, year, month, date, hours, minutes, seconds
...
export default class {
	constructor(d) {
		...
		this.solar = `${calendar.gregorianMonth}月${calendar.gregorianDay}日 ${calendar.weekday}`
		this.lunar = `${calendar.lunarMonthCn}${calendar.lunarDayCn}`
	}
}
